...
class TestHeap(unittest.TestCase):
    ...
    def test_print_live_instances_validates_command(self, mock_api):
        ...
        self.assertFalse(mock_api.return_value.android_live_get_class_instances.called)

    @mock.patch('objection.state.connection.state_connection.get_api')
    def test_print_live_instances_validates_command(self, mock_api):
        instances(['java.io.File'])

        self.assertTrue(mock_api.return_value.android_live_get_class_instances.called)
